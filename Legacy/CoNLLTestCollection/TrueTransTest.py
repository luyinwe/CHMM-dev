...
from Core.Data import extract_sequence, specialise_annotations, initialise_emissions
...
def true_trans_test(args):
    ...
    lb_indices = [[CoNLL_INDICES[i] for i in lbs] for lbs in train_labels]
